...
\section{Porovnanie SOAP a REST}
\begin{itemize}
\item REST používa pre komunikáciu protokol HTTP (popr. HTTPS), pričom SOAP môže použiť takmer ktorýkoľvek transportný protokol (SMTP, JMS...)
\end{itemize}
